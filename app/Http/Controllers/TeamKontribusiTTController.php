...
class TeamKontribusiTTController extends Controller
{
    /**
    ...
    {        
      ...
      $data['provinsi'] = SikiPropinsi::all();
    	...
    	return view('team/kontribusi_tt/index')->with($data);
    }
    ...
    {
      $data['kontribusi'] = TeamKontribusiTt::find($id);

      return view('team/kontribusi_tt/edit')->with($data);
    }
