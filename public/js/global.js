$(document).ready(function () {
  ...
  $('select').on('change', function () {
      ...
      if (value == "") {
          ...
          $(this).parent().find(".select2-container").children().children().css('background-color', '#b9cae6');
      }
  });
...
function chainedJenisNarsum(url, jenis_narsum, nama_narsum, placeholder) {
  ...
  $.ajax({
      ...
      success: function (datapro) {
          ...
          $("#" + nama_narsum).html("<option value='' selected>" + placeholder + "</option>");
          $("#" + nama_narsum).select2({
              data: datapro
          }).val(null).trigger('change');
      },
...
function chainedFilterBidang(url, bidang, pembinaan, placeholder) {
  ...
  $.ajax({
      ...
      success: function (datapro) {
          $("#" + pembinaan).html("<option value='' selected>" + placeholder + "</option>");
          $("#" + pembinaan).select2({
              data: datapro
          }).val(null).trigger('change');
      },
...
function chainedJenisUsaha(url, id_jenis_usaha, id_bidang, placeholder) {
  ...
  $.ajax({
      ...
      success: function (data) {
          $("#" + id_bidang).html("<option value='' selected>" + placeholder + "</option>");
          $("#" + id_bidang).select2({
              data: data
          }).val(null).trigger('change');
      },
