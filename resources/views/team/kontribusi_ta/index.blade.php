...
<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">Kontribusi TA</a></li>
      </ol>
    </section>
        ...
        <div class="box-body">
          ...
          <form method="get" style="margin-bottom: 20px" action="" class="form-inline float-right">
            ...
            <select name="kua" class="form-control input-sm">
              ...
              <option value="1" {{Request()->kua == 1 ? "selected" : ""}}>Utama</option>
              <option value="2" {{Request()->kua == 2 ? "selected" : ""}}>Madya</option>
              <option value="3" {{Request()->kua == 3 ? "selected" : ""}}>Muda</option>
            </select>
                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form class="form-inline edit-kontribusi" style="display: none" method="post" action="{{route('team_kontribusi_ta.update', $knt->id)}}">
                              @method('PATCH') @csrf
