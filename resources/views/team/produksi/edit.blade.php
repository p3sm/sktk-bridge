          ...
          @endif
	        ...
	        <div class="box box-primary box-content">
	          <div class="box-header with-border">
	            <h3 class="box-title">Edit Tim Produksi</h3>
	          </div>
	          <!-- /.box-header -->

	          <!-- form start -->
	          <form role="form" method="post" action="{{route('produksi.update', $data->id)}}">
	          	@method('PATCH') 
              @csrf
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label>Tim Produksi Level Diatasnya</label>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="pjk3">
                      ...
                      <option value="{{$pjk3->id}}" {{$data->pjk_lpjk_id == $pjk3->id ? "selected" : ""}}>{{$pjk3->badanUsaha->nama}}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pimpinan_no" id="pimpinan_no" placeholder="Masukan No Pimpinan" value="{{$data->pimpinan_jabatan}}">
                  </div>
                  <div class="form-group">
