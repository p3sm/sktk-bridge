                    ...
                    <tbody>
                        @foreach($results as $k => $result)
                          <tr>
                            ...
                            <td>{{$result->kode}}</td>
                            <td>{{$result->nama}}</td>
                            <td><span class='label label-primary'>{{$result->parent ? $result->parent->nama : "-"}}</span></td>
                            <td><span class='label label-warning'>{{$result->produksi->nama}}</span></td>
                            {{-- <td>
